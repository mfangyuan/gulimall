pipeline {
  ...
  stages {
    stage('拉取代码') {
      steps {
        git(url: 'https://github.com/mfangyuan/gulimall', credentialsId: 'github-id', branch: 'master', changelog: true, poll: false)
  ...
  environment {
    ...
    DOCKERHUB_NAMESPACE = 'atguigumall1'
    GITHUB_ACCOUNT = '201512825@qq.com'
